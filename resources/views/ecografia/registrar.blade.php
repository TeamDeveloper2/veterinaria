                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="/admin/ecografia_post" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Imagen de la Ecografia del Paciente:<i class="text-danger">*</i></label>
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" name="img_ecografia" value="" require>
                                </div>
                            </div>
