...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2 class="titulo" class style="background-color: #1B4F72">
            <font color="FBFBFB "> PANEL METABOLICO BASICO</font>

        <div class="container">
        <br>
          <a href="#ventana2" class="btn btn-success btn-sm" data-toggle="modal">PMB</a>

          <div class="modal fade" id="ventana2">
            <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">PMB</h4>
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('pmb_registrar')}}">Agregar</a>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->fecha}}</td>
                                    <td >
                                        <a href="{{url('/admin/pmb_show/'.$item->codpmb) }}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
                                        <a href="{{url('/admin/pmb_editar/'.$item->codpmb) }}" title="Modificar"><img width="17px" src="{{asset('img/iconos/modificar.png')}}" alt="Modificar"></a>                                        
                                    </td>
                                </tr>
                                @endforeach
