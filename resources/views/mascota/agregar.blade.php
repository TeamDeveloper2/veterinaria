                    ...
                    <div class="ibox-content">
                        <form action="{{route('homereg')}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    < type="text" class="form-control" name="nombre" value="" required="">
                                </div>
                            </div>
                            @error('nombre')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    < type="text" class="form-control" name="raza" value="" required="">
                                </div>
                            </div>
                            @error('raza')
                                <div class="alert alert-danger alert-dismissable">"inserte mensaje aca si es necesario"<button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    < type="date" class="form-control" name="fecha_nacimiento" value="" required="">
                                </div>
                            </div>
