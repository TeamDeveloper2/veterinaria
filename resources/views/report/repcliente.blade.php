    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-12">
            <h2 class="titulo" class style="background-color: #1B4F72">
                <font color="FBFBFB ">Reporte Clientes</font>
        </div>
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-danger" href=>Exportar a PDF</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>

                    <a class="btn btn-primary" href=>Exportar a XLS</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>

                    <a class="btn btn-info" href=>Exportar a HTML</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    ...
                    <div class="row"><div class="col-sm-12 m-b-xs"><span class="text-success">Total de clientes: <strong>00</strong></span></div></div>
